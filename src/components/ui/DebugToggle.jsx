...
export default function DebugToggle() {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <label className="flex items-center gap-1.5 cursor-pointer text-gray-500 hover:text-gray-700 transition-colors" title="Show structural framing (studs, plates, headers) for construction view">
        <input
          type="checkbox"
          checked={showFraming}
